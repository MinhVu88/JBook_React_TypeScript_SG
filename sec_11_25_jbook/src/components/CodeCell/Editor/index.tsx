...
export const Editor: React.FC<CodeEditorProps> = ({initialValue, onChange}) => {
  ...
  const handleEditorDidMount: EditorDidMount = (
    ...
    monacoEditor.onDidChangeModelContent(() => {
      console.log('\nCodeEditor.tsx | handleEditorDidMount() | getCurrentUserInput() ->',getCurrentUserInput());
  ...
  const formatCode = () => {
    console.log('\nCodeEditor.tsx | formatCode() | monacoEditorRef.current ->',monacoEditorRef.current);
    ...
    const formattedUserInput = prettier.format(
