...
exports.setCellsRouter = void 0;
var fs_1 = require("fs");
var path_1 = __importDefault(require("path"));
var express_1 = __importDefault(require("express"));
var setCellsRouter = function (fileName, dir) {
    var router = express_1.default.Router();
    var fullFilePath = path_1.default.join(dir, fileName);
    ...
    router.get('/cells', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 6]);
                    return [4 /*yield*/, fs_1.promises.readFile(fullFilePath, { encoding: 'utf-8' })];
                case 1:
                    cells = _a.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, fs_1.promises.writeFile(fullFilePath, '[]', 'utf-8')];
                case 3:
                    _a.sent();
                    res.send([]);
                    return [3 /*break*/, 5];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fs_1.promises.writeFile(fullFilePath, JSON.stringify(cells), 'utf-8')];
                case 1:
                    _a.sent();
                    res.send({ status: 'ok' });
                    return [2 /*return*/];
...
exports.setCellsRouter = setCellsRouter;
